...
# x64
echo "[Windows x64 build $VERSION ($HASH)](https://s3-us-west-2.amazonaws.com/tc-builds.door43.org/$FILE64) is ready for download." >> ../build_meta/comment.md
...
# x32
echo "[Windows x32 build $VERSION ($HASH)](https://s3-us-west-2.amazonaws.com/tc-builds.door43.org/$FILE32) is ready for download." >> ../build_meta/comment.md
